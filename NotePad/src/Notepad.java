...
/////////////////////////
void setNpd(Notepad npd2){npd=npd2;}
...
//tabs = new ArrayList<JTextArea>();
//tabs2= new JTextArea[5];
t1=new JTextArea(30,60);
t2=new JTextArea(30,60);
t3=new JTextArea(30,60);
t4=new JTextArea(30,60);
t5=new JTextArea(30,60);
ta=t5;
...
fh5=new FileOperation(this);

jsp.setColumnHeaderView(t2); 
fh2=new FileOperation(this);
jsp.setColumnHeaderView(t3); 
fh3=new FileOperation(this);
jsp.setColumnHeaderView(t4); 
fh4=new FileOperation(this);
jsp.setColumnHeaderView(t1); 
fh1=new FileOperation(this);
...
else if(cmdText.equals(tabs_5))
{
	jsp.setColumnHeaderView(t5); 
...
JMenu tabsMenu=createMenu(tabs_av,KeyEvent.VK_B,mb);
...
createMenuItem(tabs_1,KeyEvent.VK_1,tabsMenu,KeyEvent.VK_1,this);
createMenuItem(tabs_2,KeyEvent.VK_2,tabsMenu,KeyEvent.VK_2,this);
createMenuItem(tabs_3,KeyEvent.VK_3,tabsMenu,KeyEvent.VK_3,this);
createMenuItem(tabs_4,KeyEvent.VK_4,tabsMenu,KeyEvent.VK_4,this);
createMenuItem(tabs_5,KeyEvent.VK_5,tabsMenu,KeyEvent.VK_5,this);
...
final String tabs_1="tab1";
final String tabs_2="tab2";
final String tabs_3="tab3";
final String tabs_4="tab4";
final String tabs_5="tab5";
